...
from graph.t2_e1_strongly_connected_component import depth_first_search, sort_vertices_by_final_times, search_and_print_strongly_connected_components
...
def initGraph3():
    ...
    return Graph(v, edges, oriented=True)
